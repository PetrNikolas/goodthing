  ...
  return (
    <ErrorWrapper>
      <ErrorConatent>
        ...
        <Heading {...title} content="Stránka nenalezena!" />
        <Text
          {...text}
          content="Vypadá to, že stránka, kterou se pokoušíte navštívit, neexistuje. Zkontrolujte prosím URL a zkuste znovu štěstí."
        />
        <ButtonWrapper>
          <Button
            {...reloadButton}
