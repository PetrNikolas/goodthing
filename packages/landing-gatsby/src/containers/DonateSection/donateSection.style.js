...
export const DonateButton = styled.button`
  ...
  cursor: pointer;
  color: ${themeGet('colors.white', '#ffffff')};
  background-color: ${themeGet('colors.secondary', '#0f33ff')};
  position: relative;
  overflow: hidden;
  z-index: 1;
  margin-top: 50px;
  ...
  &::before {
    ...
    background: repeating-linear-gradient(
      -45deg,
      ${themeGet('colors.secondary', '#0f33ff')},
      ${themeGet('colors.secondary', '#0f33ff')} 10px,
    ...
    @media only screen and (max-width: 1440px) {
      background: repeating-linear-gradient(
        -45deg,
        ${themeGet('colors.secondary', '#0f33ff')},
        ${themeGet('colors.secondary', '#0f33ff')} 8px,
