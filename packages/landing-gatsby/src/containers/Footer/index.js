    ...
    <FooterWrapper>
      <Container width="1260px">
        {/*<Box className="row" {...row}>*/}
          {/*<Box className="col-one col-full" {...colOne}>
            <Text className="text" content="CZ: +420 732 285 585" />
            <a aria-label="go to mail" href="mailto:hello@petrnikolas.com" className="mail">
              hello@petrnikolas.com
            </a>
            <SelectWrapper>
        ...
        <Box className="row copyright" {...row}>
          <CopyrightText>
            <Text
              className="text"
              content="© 2019 GoodThing | by Petr Nikolas Prokop"
            />
          </CopyrightText>
          {/*<SocialList>
